...
double VelocityZoneAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}
...
int VelocityZoneAudioProcessor::getCurrentProgram()
{
    return 0;
}
...
void VelocityZoneAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}

//==============================================================================
void VelocityZoneAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool VelocityZoneAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
#if JucePlugin_IsMidiEffect
...
void VelocityZoneAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
//==============================================================================
void VelocityZoneAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void VelocityZoneAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
