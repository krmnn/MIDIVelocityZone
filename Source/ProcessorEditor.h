...
//{
//public:
//    OJDPedalComponent (OJDAudioProcessor&, ProcessorEditor&);
//
...
{
public:
    ProcessorEditor (VelocityZoneAudioProcessor&);
...
private:
    void addPresetManager (VelocityZoneAudioProcessor& processorToControl);
    void setupAndAddMessageOfTheDayComponents();
    
    void checkMessageOfTheDay (VelocityZoneAudioProcessor& processor);
