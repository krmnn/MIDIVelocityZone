...
//================ IDs =================================================================================================
const juce::String OJDParameters::Sliders::Kick::id  ("Kick");
...
#define MAKE_ROTARY_PARAMETER(Name)                                                          \
    std::make_unique<juce::AudioParameterFloat> (Sliders::Name::id, #Name, OJDParameters::Sliders::displayRange, 5.0f)
